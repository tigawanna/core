...
const buildFetcher = async (robotsFiles: {
  [robotsUrl: string]: string;
}): Promise<{ fetcher: Fetcher; fetchedUrls: string[] }> => {
...
test('checkRobotsFile - No robots file', async () => {
  await runRobotsTest([{ url: 'https://example.com/favicon.png', type: 'png' }], {}, [
    {
