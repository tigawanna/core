...
describe('stringToSvg', () => {
  ...
  it('should preserve SVG children', () => {
    const svgString =
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"><circle cx="25" cy="25" r="10" fill="blue"/></svg>';
  ...
  it('should handle SVG with explicit width and height', () => {
    const svgString =
      '<svg xmlns="http://www.w3.org/2000/svg" width="200" height="150" viewBox="0 0 200 150"><rect width="200" height="150" fill="green"/></svg>';
  ...
  it('should strip DOCTYPE declarations', () => {
    const svgString =
      '<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect width="100" height="100" fill="red"/></svg>';
  ...
  it('should handle non-square viewBox', () => {
    const svgString =
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 100"><rect width="300" height="100" fill="yellow"/></svg>';
